...
- **目標**: 完整的開發指南
- **放置位置**: docs/ 目錄下
- **技術棧**: Go + HTMX + Alpine.js + Templ + DaisyUI + WebSocket + SQLC + Postgres + Docker

> 請盡可能使用Go標準庫，只有在引入第三方庫會更好的時候，才考慮引入(例如: gorilla/mux )，在引入之前，請先使用bright-data查詢，確保有更好用的第三方庫能用
